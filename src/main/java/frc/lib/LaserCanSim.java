...
public class LaserCanSim implements LaserCanInterface {
     ...
     *
     * @param can_id The CAN ID for the LaserCAN sensor. This ID is unique, and set
     *               in GrappleHook. Note: one ID should be
    ...
    /**
     * Get the most recent measurement from the sensor, if available. May return
     * null.
     */
    @Override
    ...
    /**
     * Set the measurement (only the measurement parameters, not including ranging
     * mode, timing budget, or ROI - these
